...
if not st.session_state["logged_in"]:
    ...
    with st.container():
        # Using absolute positioning to place widgets over the HTML container
        st.markdown('<div style="position: absolute; top: 185px; left: 50px; width: 350px; z-index: 1000;">', unsafe_allow_html=True)
